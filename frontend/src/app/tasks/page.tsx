        ...
        <main className="pt-32 px-4 mx-auto max-w-7xl">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
            <div>
              ...
              <p className="text-zinc-400 mt-2">Find work, contribute, and earn rewards (STX & USDCx).</p>
            </div>
                    ...
                    <CardHeader className="pb-4">
                      <div className="flex justify-between items-start mb-2">
                         ...
                         <span className="text-orange-500 font-bold text-lg">
                           {(task.tokenType === "USDCx" ? Number(task.fundingAmount) / 1000000 : formatSTX(task.fundingAmount))} {task.tokenType || "STX"}
                         </span>
                      </div>
